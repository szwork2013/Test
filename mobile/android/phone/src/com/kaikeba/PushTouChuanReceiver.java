...
public class PushTouChuanReceiver extends BroadcastReceiver {
...
//                        GetuiSdkDemoActivity.tLogView.append(data + "\n");
            ...
            case PushConsts.GET_CLIENTID:
                ...
                prefsEditor.putString(API.CLIENTID, cid);
                prefsEditor.commit();
...
//                            pushInfo = new PushInfo(cid, API.getAPI().getUserObject().getId(),"","",API.getAPI().getUserObject().getEmail());
//                        }else {
//                            pushInfo = new PushInfo(cid, 0,"","","");
//                        }
//                        UploadData.getInstance().addDbData(context,pushInfo,"push");
//                    } catch (DbException e) {
//                        e.printStackTrace();
//                    }
                    UploadData.getInstance().uploadPushInfo(context);
                }
//                Log.d("jack","cid:" + cid);
