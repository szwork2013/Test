        ...
        if (type.equals(Contents.Type.TEXT)) {
            ...
            if (bundle != null) {
                ...
                if (!encoded[1].isEmpty()) {
                    ...
                    Bundle b = intent.getBundleExtra(Intents.Encode.DATA);
                    if (b != null) {
                        // These must use Bundle.getFloat(), not getDouble(), it's part of the API.
                        float latitude = b.getFloat("LAT", Float.MAX_VALUE);
                        float longitude = b.getFloat("LONG", Float.MAX_VALUE);
