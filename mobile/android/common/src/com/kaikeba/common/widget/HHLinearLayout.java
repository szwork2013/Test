 ...
 */
public class HHLinearLayout extends ViewGroup {
    private int mCellWidth;
    private int mCellHeight;

    public HHLinearLayout(Context context) {
        super(context);
    }

    public HHLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HHLinearLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public void setmCellWidthHight(int w, int h) {
        mCellWidth = w;
        mCellHeight = h;
        requestLayout();
    }
