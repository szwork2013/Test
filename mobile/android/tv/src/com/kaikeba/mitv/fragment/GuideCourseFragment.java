...
public class GuideCourseFragment extends Fragment {
    ...
    public static GuideCourseFragment newInstance() {
        GuideCourseFragment newFragment = new GuideCourseFragment();
        return newFragment;
    }
...
//
//                        //
//                        guideInfo = CoursesAPI.getGudieAllCourse(currentAllcourse, categories);
...
//                                    mContentLL, isFirstLine ? R.id.tv_tab_guide: -1);
//                            isFirstLine = false;
//                        }
//                    }
//                });
