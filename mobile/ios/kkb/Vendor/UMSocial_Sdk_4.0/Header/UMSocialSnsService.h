...
/**
 处理app的URL方法
 若除了 UMSocial
 SDK外，还需要处理其他url，可以针对url的前缀作处理，例如下面写法：
 ...
 */
+ (BOOL)handleOpenURL:(NSURL *)url
        wxApiDelegate:(id<WXApiDelegate>)wxApiDelegate;
...
/**
 ...
 @param shareImage
 可以传入`UIImage`，或者`NSData`类型，分享内嵌图片,用户可以在编辑页面删除
 @param snsNames
 你要分享到的sns平台类型，该NSArray值是`UMSocialSnsPlatformManager.h`定义的平台名的字符串常量，有UMShareToSina，UMShareToTencent，UMShareToRenren，UMShareToDouban，UMShareToQzone，UMShareToEmail，UMShareToSms等
