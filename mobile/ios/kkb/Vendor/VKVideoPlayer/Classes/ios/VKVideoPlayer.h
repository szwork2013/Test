...
typedef enum {
    // The video was flagged as blocked due to licensing restrictions (geo or
    // device).
...
typedef enum {
    ...
    VKVideoPlayerStateDismissed, // Player dismissed when dismissing view
                                 // controller
...
- (void)videoPlayer:(VKVideoPlayer *)videoPlayer
    willChangeStateTo:(VKVideoPlayerState)toState;
- (void)videoPlayer:(VKVideoPlayer *)videoPlayer
    didChangeStateFrom:(VKVideoPlayerState)fromState;
- (BOOL)shouldVideoPlayer:(VKVideoPlayer *)videoPlayer
               startVideo:(id<VKVideoPlayerTrackProtocol>)track;
- (void)videoPlayer:(VKVideoPlayer *)videoPlayer
...
- (void)videoPlayer:(VKVideoPlayer *)videoPlayer
       didPlayFrame:(id<VKVideoPlayerTrackProtocol>)track
...
@interface VKVideoPlayer
    : NSObject <VKVideoPlayerViewDelegate, UIAlertViewDelegate>
...
@property(nonatomic, strong)
    id<VKVideoPlayerExternalMonitorProtocol> externalMonitor;
